...
def get_showings_by_zone(zone: str = 'santiago-oriente') -> List[Dict[str, Any]]:
    ...
    showings = requests.post(f'{CINEHOYTS_HOST}/Cartelera.aspx/GetNowPlayingByCity', json=payload)
...
def get_show_by_date(cinema_cities: List[Dict[str, Any]], date_name: str)-> Dict[str, Any]:
...
def get_showings(city: str, zone: str, date: str, movie: str):
    ...
    showings = []
    showings_text = f'{movie_title} está en {city_name} el {showtime_date} a las\n'
